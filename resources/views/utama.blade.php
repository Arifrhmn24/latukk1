...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">AR store</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">menjual berbagai sneakers berkualitas</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">sesuaikan gengsi dengan budged yang kamu punya</h2>
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="/login" class="btn-get-started scrollto">Join Now</a>
                    </div>
                </div>
        ...
        <section id="produk" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>AR Shoe store</h2>
                    <p>berikut sneakers berkualitas</p>
                </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>AR company</strong>. All Rights Reserved
                    </div>
                    <div class="credits">
